"""
Django settings for ip_visualization project.
...
SECRET_KEY = 'django-insecure-@vsgw0%mabf5rkfmni4!yuk3#rm0w)-y1%=!atl!j=-bxu5dv+'
...
ROOT_URLCONF = 'ip_visualization.urls'
...
WSGI_APPLICATION = 'ip_visualization.wsgi.application'
